...
export const COLORS = {
  primary: '#ed3b91', // Pink is the Pulse
  interaction: '#08b8fb', // Blue is the Brain
  neutral: {
    textMain: '#091e42',
    textSecondary: '#6882a9',
...
export const TOKENS = {
  ...
  shadow: {
    sm: 'shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)]',
    ...
    glow: 'shadow-[0_0_20px_rgba(237,59,145,0.15)]',
  },
  animation: {
    durations: {
      fast: '150ms',
  ...
  typography: {
    ...
    xs: 'text-[0.75rem] font-medium uppercase tracking-[0.1em]',
  }
};

export const FOCUS_RING = `focus:ring-2 focus:ring-[#08b8fb] focus:ring-offset-2 focus:outline-none transition-all duration-150`;
...
export const GAME_CONFIG = {
  ...
  feedbackAnimationDuration: 600,
  resultCountUpDuration: 1500,
};
...
export const Icons = {
  ...
  FileCode: () => (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9 15L11 17L9 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M15 15L13 17L15 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  Upload: () => (
  ...
  Mascot: () => (
    <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ed3b91" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="2" width="20" height="20" rx="5" strokeWidth="2"/>
      <circle cx="8" cy="10" r="1.5" fill="#ed3b91"/>
      <circle cx="16" cy="10" r="1.5" fill="#ed3b91"/>
      <path d="M7 16C7 16 9 18 12 18C15 18 17 16 17 16" strokeWidth="2"/>
    </svg>
  ),
  Clock: () => (
  ...
  Star: ({ filled = false, size = 20 }: { filled?: boolean; size?: number }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
  ),
  Fire: () => (
